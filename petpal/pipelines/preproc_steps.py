...
class TACsFromSegmentationStep(FunctionBasedStep):
    ...
    def default_write_tacs_from_segmentation_rois(cls):
        return cls(input_image_path='', segmentation_image_path='', segmentation_label_map_path='', out_tacs_dir='',
                   out_tacs_prefix='', time_keyword='FrameReferenceTime', verbose=False)
